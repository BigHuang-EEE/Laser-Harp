...
A Raspberry Pi Python script that turns three paired laser emitters/receivers into
an interactive harp. Hitting a receiver with its laser plays the matching **do / re / mi**
...
- 3 × laser diode outputs (wired to GPIO output pins)
